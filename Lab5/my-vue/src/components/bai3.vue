...
// Khai báo một đối tượng reactive để quản lý các trường dữ liệu
const userInfo = reactive({
    name: 'Đặng Chí Bảo', // Giá trị khởi tạo
    email: 'baodang7122006@fpt.edu.vn', // Giá trị khởi tạo
    isSubscribed: true // Giá trị khởi tạo
});
</script>